...
@AGENTS.md @docs/MAINTENANCE_GUIDE.md
...
python tools/context_optimizer.py --task "fix bug" --target-file "src/position.cpp"
.github/automation/context_updater.sh       # Documentation maintenance script
```
