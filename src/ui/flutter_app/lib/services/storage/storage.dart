...
class LocalDatabaseService {
  ...
  static set colorSettings(ColorSettings settings) =>
      _colorSettingsBox.put(colorSettingsKey, settings);
  ...
  /// saves the given [settings] to the settings Box
  static set display(Display settings) => _displayBox.put(displayKey, settings);
  ...
  /// saves the given [settings] to the settings Box
  static set rules(Rules settings) => _rulesBox.put(rulesKey, settings);
