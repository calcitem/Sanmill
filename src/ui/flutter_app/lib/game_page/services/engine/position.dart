...
///////////////////////////////////////////////////////////////////////////////
    ...
    if (phase == Phase.placing && action == Act.place) {
      ...
      if (n == 0) {
        ...
        final int totalCaptureRemoval =
            custodianRemoval + interventionRemoval;
  ...
  void _setInterventionCaptureState(
    ...
    if (clampedPrev != clampedNew) {
      st.key ^=
          _Zobrist.interventionCount[color.index][clampedPrev as int];
      st.key ^=
          _Zobrist.interventionCount[color.index][clampedNew as int];
    }
  ...
  bool _checkInterventionCapture(
    ...
    if ((placingPhase && !DB().ruleSettings.interventionCaptureInPlacingPhase) ||
