...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -2091852686;
...
abstract class RustLibApi extends BaseApi {
  ...
  void crateApiSimpleMillHumanDbDeinit();

  bool crateApiSimpleMillHumanDbInit({required String path});

  MillHumanDatabaseQuery crateApiSimpleMillHumanDbQuery({
    required String fen,
    required int maxMoves,
    required int minSamples,
  });

  MillHumanDatabaseStatus crateApiSimpleMillHumanDbStatus({
    required String path,
  });

  void crateApiSimpleMillPatchDeinit();

  bool crateApiSimpleMillPatchInit({required String path});

  MillPatchStatus crateApiSimpleMillPatchStatus();

  void crateApiSimpleMillPerfectDbDeinit();

  bool crateApiSimpleMillPerfectDbInit({required String path});

  MillPerfectDatabaseStatus crateApiSimpleMillPerfectDbStatus({
    required String path,
  });
  ...
  int crateApiSimpleNativeMillSearchActionCapacity();
  ...
  TgfAction? crateApiMillKernelTgfKernelMillPatchMakeTrapsAction({
    required int handle,
    required TgfAction chosen,
  });

  TgfAction? crateApiMillKernelTgfKernelMillPatchTrapAwareBestAction({
    required int handle,
    required MillEngineConfig config,
    required bool makeTraps,
  });

  int? crateApiMillKernelTgfKernelMillPatchTrapScoreAfter({
    required int handle,
    required TgfAction action,
  });

  MillAnalysisReport crateApiMillKernelTgfKernelMillPerfectDbAnalyze({
    required int handle,
    required bool trapAwareness,
  });

  TgfAction? crateApiMillKernelTgfKernelMillPerfectDbBestAction({
    required int handle,
    required MillEngineConfig config,
  });

  Stream<EngineEvent> crateApiMillKernelTgfKernelMillPonderEvents({
    required int handle,
  ...
  bool crateApiMillKernelTgfKernelMillPonderHit({
    required int handle,
    required int requestId,
  });

  bool crateApiMillKernelTgfKernelMillPonderStop({required int requestId});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void crateApiSimpleMillHumanDbDeinit() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimpleMillHumanDbDeinitConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleMillHumanDbDeinitConstMeta =>
      const TaskConstMeta(debugName: "mill_human_db_deinit", argNames: []);
  ...
  bool crateApiSimpleMillHumanDbInit({required String path}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimpleMillHumanDbInitConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleMillHumanDbInitConstMeta =>
      const TaskConstMeta(debugName: "mill_human_db_init", argNames: ["path"]);
    ...
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          ...
          sse_encode_u_32(maxMoves, serializer);
          sse_encode_u_32(minSamples, serializer);
          return pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 6)!;
        },
        codec: SseCodec(
          decodeSuccessData: sse_decode_mill_human_database_query,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiSimpleMillHumanDbQueryConstMeta,
        argValues: [fen, maxMoves, minSamples],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiSimpleMillHumanDbQueryConstMeta =>
      const TaskConstMeta(
        debugName: "mill_human_db_query",
        argNames: ["fen", "maxMoves", "minSamples"],
      );
  ...
  MillHumanDatabaseStatus crateApiSimpleMillHumanDbStatus({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_mill_human_database_status,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiSimpleMillHumanDbStatusConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleMillHumanDbStatusConstMeta =>
      const TaskConstMeta(
        debugName: "mill_human_db_status",
        argNames: ["path"],
      );
  ...
  void crateApiSimpleMillPatchDeinit() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimpleMillPatchDeinitConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleMillPatchDeinitConstMeta =>
      const TaskConstMeta(debugName: "mill_patch_deinit", argNames: []);
  ...
  bool crateApiSimpleMillPatchInit({required String path}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimpleMillPatchInitConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleMillPatchInitConstMeta =>
      const TaskConstMeta(debugName: "mill_patch_init", argNames: ["path"]);
  ...
  MillPatchStatus crateApiSimpleMillPatchStatus() {
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_mill_patch_status,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiSimpleMillPatchStatusConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleMillPatchStatusConstMeta =>
      const TaskConstMeta(debugName: "mill_patch_status", argNames: []);
  ...
  MillPerfectDatabaseStatus crateApiSimpleMillPerfectDbStatus({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_mill_perfect_database_status,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiSimpleMillPerfectDbStatusConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleMillPerfectDbStatusConstMeta =>
      const TaskConstMeta(
        debugName: "mill_perfect_db_status",
        argNames: ["path"],
      );
  ...
  int crateApiSimpleNativeMillSearchActionCapacity() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiSimpleNativeMillSearchActionCapacityConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSimpleNativeMillSearchActionCapacityConstMeta =>
      const TaskConstMeta(
        debugName: "native_mill_search_action_capacity",
        argNames: [],
      );
  ...
  TgfAction? crateApiMillKernelTgfKernelMillPatchCorrectAction({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMillKernelTgfKernelMillPatchCorrectActionConstMeta,
        argValues: [handle, chosen],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiMillKernelTgfKernelMillPatchCorrectActionConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_patch_correct_action",
        argNames: ["handle", "chosen"],
      );
  ...
  TgfAction? crateApiMillKernelTgfKernelMillPatchMakeTrapsAction({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiMillKernelTgfKernelMillPatchMakeTrapsActionConstMeta,
        argValues: [handle, chosen],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMillKernelTgfKernelMillPatchMakeTrapsActionConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_patch_make_traps_action",
        argNames: ["handle", "chosen"],
      );
  ...
  TgfAction? crateApiMillKernelTgfKernelMillPatchTrapAwareBestAction({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta:
            kCrateApiMillKernelTgfKernelMillPatchTrapAwareBestActionConstMeta,
        argValues: [handle, config, makeTraps],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiMillKernelTgfKernelMillPatchTrapAwareBestActionConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_patch_trap_aware_best_action",
        argNames: ["handle", "config", "makeTraps"],
      );
  ...
  int? crateApiMillKernelTgfKernelMillPatchTrapScoreAfter({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMillKernelTgfKernelMillPatchTrapScoreAfterConstMeta,
        argValues: [handle, action],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiMillKernelTgfKernelMillPatchTrapScoreAfterConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_patch_trap_score_after",
        argNames: ["handle", "action"],
      );
  ...
  MillAnalysisReport crateApiMillKernelTgfKernelMillPerfectDbAnalyze({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMillKernelTgfKernelMillPerfectDbAnalyzeConstMeta,
        argValues: [handle, trapAwareness],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMillKernelTgfKernelMillPerfectDbAnalyzeConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_perfect_db_analyze",
        argNames: ["handle", "trapAwareness"],
      );
  ...
  TgfAction? crateApiMillKernelTgfKernelMillPerfectDbBestAction({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMillKernelTgfKernelMillPerfectDbBestActionConstMeta,
  ...
  TaskConstMeta
  get kCrateApiMillKernelTgfKernelMillPerfectDbBestActionConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_perfect_db_best_action",
      ...
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            ...
            sse_encode_list_tgf_action(predictedActions, serializer);
            sse_encode_box_autoadd_mill_engine_config(config, serializer);
            sse_encode_StreamSink_engine_event_Sse(sink, serializer);
            pdeCallFfi(
              generalizedFrbRustBinding,
          ...
          constMeta: kCrateApiMillKernelTgfKernelMillPonderEventsConstMeta,
          argValues: [handle, requestId, predictedActions, config, sink],
          apiImpl: this,
        ),
      ),
    );
  ...
  TaskConstMeta get kCrateApiMillKernelTgfKernelMillPonderEventsConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_ponder_events",
        argNames: ["handle", "requestId", "predictedActions", "config", "sink"],
      );
  ...
  bool crateApiMillKernelTgfKernelMillPonderHit({
    ...
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMillKernelTgfKernelMillPonderHitConstMeta,
  ...
  TaskConstMeta get kCrateApiMillKernelTgfKernelMillPonderHitConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_ponder_hit",
  ...
  bool crateApiMillKernelTgfKernelMillPonderStop({required int requestId}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMillKernelTgfKernelMillPonderStopConstMeta,
        argValues: [requestId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMillKernelTgfKernelMillPonderStopConstMeta =>
      const TaskConstMeta(
        debugName: "tgf_kernel_mill_ponder_stop",
        argNames: ["requestId"],
      );
  ...
  List<MillHumanDatabaseMove> dco_decode_list_mill_human_database_move(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_mill_human_database_move)
        .toList();
  }
  ...
  List<MillMoveAnalysis> dco_decode_list_mill_move_analysis(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_mill_move_analysis).toList();
  }
  ...
  @protected
  MillAnalysisReport dco_decode_mill_analysis_report(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return MillAnalysisReport(
      moves: dco_decode_list_mill_move_analysis(arr[0]),
      traps: dco_decode_list_String(arr[1]),
    );
  }
  ...
  MillHumanDatabaseMove dco_decode_mill_human_database_move(dynamic raw) {
    ...
    if (arr.length != 7)
      throw Exception('unexpected arr length: expect 7 but see ${arr.length}');
    return MillHumanDatabaseMove(
      notation: dco_decode_String(arr[0]),
      wins: dco_decode_u_32(arr[1]),
      losses: dco_decode_u_32(arr[2]),
      draws: dco_decode_u_32(arr[3]),
      total: dco_decode_u_32(arr[4]),
      winPct: dco_decode_f_64(arr[5]),
      scoreDelta: dco_decode_f_64(arr[6]),
    );
  }
  ...
  MillHumanDatabaseQuery dco_decode_mill_human_database_query(dynamic raw) {
    ...
    return MillHumanDatabaseQuery(
      available: dco_decode_bool(arr[0]),
      stateKey: dco_decode_String(arr[1]),
      error: dco_decode_String(arr[2]),
      moves: dco_decode_list_mill_human_database_move(arr[3]),
    );
  }
  ...
  MillHumanDatabaseStatus dco_decode_mill_human_database_status(dynamic raw) {
    ...
    return MillHumanDatabaseStatus(
      readable: dco_decode_bool(arr[0]),
      initialized: dco_decode_bool(arr[1]),
      error: dco_decode_String(arr[2]),
      schemaVersion: dco_decode_String(arr[3]),
      buildDate: dco_decode_String(arr[4]),
      totalGames: dco_decode_u_32(arr[5]),
      positionCount: dco_decode_u_32(arr[6]),
      moveCount: dco_decode_u_32(arr[7]),
    );
  }
  ...
  MillMoveAnalysis dco_decode_mill_move_analysis(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return MillMoveAnalysis(
      mv: dco_decode_String(arr[0]),
      outcome: dco_decode_String(arr[1]),
      value: dco_decode_i_32(arr[2]),
      steps: dco_decode_i_32(arr[3]),
    );
  }
  ...
  MillPerfectDatabaseStatus dco_decode_mill_perfect_database_status(
    ...
    return MillPerfectDatabaseStatus(
      ...
      hasMetadata: dco_decode_bool(arr[2]),
      hasAvailableSectors: dco_decode_bool(arr[3]),
      variants: dco_decode_list_mill_perfect_database_variant_status(arr[4]),
    );
  }
  ...
  dco_decode_mill_perfect_database_variant_status(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return MillPerfectDatabaseVariantStatus(
  ...
  TgfAction? dco_decode_opt_box_autoadd_tgf_action(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_tgf_action(raw);
  }
  ...
  List<MillHumanDatabaseMove> sse_decode_list_mill_human_database_move(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MillHumanDatabaseMove>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_mill_human_database_move(deserializer));
    }
    return ans_;
  }

  @protected
  List<MillMoveAnalysis> sse_decode_list_mill_move_analysis(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MillMoveAnalysis>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_mill_move_analysis(deserializer));
    }
    return ans_;
  }
  ...
  sse_decode_list_mill_perfect_database_variant_status(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MillPerfectDatabaseVariantStatus>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
  ...
  @protected
  MillAnalysisReport sse_decode_mill_analysis_report(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_moves = sse_decode_list_mill_move_analysis(deserializer);
    var var_traps = sse_decode_list_String(deserializer);
    return MillAnalysisReport(moves: var_moves, traps: var_traps);
  }
  ...
  MillHumanDatabaseMove sse_decode_mill_human_database_move(
    ...
    var var_wins = sse_decode_u_32(deserializer);
    var var_losses = sse_decode_u_32(deserializer);
    var var_draws = sse_decode_u_32(deserializer);
    var var_total = sse_decode_u_32(deserializer);
    var var_winPct = sse_decode_f_64(deserializer);
    var var_scoreDelta = sse_decode_f_64(deserializer);
    return MillHumanDatabaseMove(
  ...
  MillHumanDatabaseQuery sse_decode_mill_human_database_query(
    ...
    var var_moves = sse_decode_list_mill_human_database_move(deserializer);
    return MillHumanDatabaseQuery(
  ...
  MillHumanDatabaseStatus sse_decode_mill_human_database_status(
    ...
    var var_positionCount = sse_decode_u_32(deserializer);
    var var_moveCount = sse_decode_u_32(deserializer);
    return MillHumanDatabaseStatus(
  ...
  MillMoveAnalysis sse_decode_mill_move_analysis(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_mv = sse_decode_String(deserializer);
  ...
  MillPerfectDatabaseStatus sse_decode_mill_perfect_database_status(
    ...
    var var_hasAvailableSectors = sse_decode_bool(deserializer);
    var var_variants = sse_decode_list_mill_perfect_database_variant_status(
      deserializer,
    );
    return MillPerfectDatabaseStatus(
      readable: var_readable,
      ...
      hasAvailableSectors: var_hasAvailableSectors,
  ...
  @protected
  MillPerfectDatabaseVariantStatus
  sse_decode_mill_perfect_database_variant_status(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_name = sse_decode_String(deserializer);
    var var_pieceCount = sse_decode_u_8(deserializer);
    var var_sectorCount = sse_decode_u_32(deserializer);
    var var_availableSectorCount = sse_decode_u_32(deserializer);
    return MillPerfectDatabaseVariantStatus(
      name: var_name,
  ...
  TgfAction? sse_decode_opt_box_autoadd_tgf_action(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_tgf_action(deserializer));
    } else {
      return null;
    }
  }
  ...
  void sse_encode_list_mill_human_database_move(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_mill_human_database_move(item, serializer);
    }
  }

  @protected
  void sse_encode_list_mill_move_analysis(
    List<MillMoveAnalysis> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_mill_move_analysis(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_mill_analysis_report(
    MillAnalysisReport self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_mill_move_analysis(self.moves, serializer);
    sse_encode_list_String(self.traps, serializer);
  }
  ...
  void sse_encode_mill_human_database_move(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.notation, serializer);
    sse_encode_u_32(self.wins, serializer);
    sse_encode_u_32(self.losses, serializer);
    sse_encode_u_32(self.draws, serializer);
    sse_encode_u_32(self.total, serializer);
    sse_encode_f_64(self.winPct, serializer);
    sse_encode_f_64(self.scoreDelta, serializer);
  }
  ...
  void sse_encode_mill_human_database_query(
    ...
    sse_encode_list_mill_human_database_move(self.moves, serializer);
  }
  ...
  void sse_encode_mill_human_database_status(
    ...
    sse_encode_u_32(self.positionCount, serializer);
    sse_encode_u_32(self.moveCount, serializer);
  }
  ...
  void sse_encode_mill_move_analysis(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.mv, serializer);
  ...
  void sse_encode_mill_perfect_database_status(
    ...
    sse_encode_bool(self.hasAvailableSectors, serializer);
    sse_encode_list_mill_perfect_database_variant_status(
      self.variants,
      serializer,
    );
  }
  ...
  void sse_encode_opt_box_autoadd_tgf_action(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_tgf_action(self, serializer);
    }
  }
