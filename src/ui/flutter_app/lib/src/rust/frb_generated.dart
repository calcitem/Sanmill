...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1285205068;
...
abstract class RustLibApi extends BaseApi {
  ...
  // Phase 6.A.1 setup-position API — implementations generated by
  // flutter_rust_bridge_codegen; stubs provided until regeneration.
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  // Phase 6.A.1: setup-position stubs — replaced by codegen on next
  // flutter_rust_bridge_codegen generate run.  The funcIds below will be
  // assigned by codegen; until then these throw at runtime to surface the
  // missing regeneration step clearly rather than silently returning wrong
  // data.
  @override
  TgfSnapshot crateApiKernelTgfKernelSetupClear({required int handle}) {
    throw UnimplementedError(
      'tgf_kernel_setup_clear requires flutter_rust_bridge_codegen generate '
      'to be run after adding the Rust implementation.',
    );
  }
  ...
  TgfSnapshot crateApiKernelTgfKernelSetupSetPiece({
    ...
    throw UnimplementedError(
      'tgf_kernel_setup_set_piece requires flutter_rust_bridge_codegen generate.',
    );
  }
  ...
  TgfSnapshot crateApiKernelTgfKernelSetupSetSide({
    ...
    throw UnimplementedError(
      'tgf_kernel_setup_set_side requires flutter_rust_bridge_codegen generate.',
    );
  }
  ...
  TgfSnapshot crateApiKernelTgfKernelSetupFinish({required int handle}) {
    throw UnimplementedError(
      'tgf_kernel_setup_finish requires flutter_rust_bridge_codegen generate.',
    );
  }
