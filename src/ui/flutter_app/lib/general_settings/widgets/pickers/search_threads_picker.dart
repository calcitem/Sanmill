...
class _SearchThreadsPicker extends StatelessWidget {
  ...
  void _commit(BuildContext context, int value) {
    assert(
      GeneralSettings.supportedEngineThreadCounts.contains(value),
      'Unsupported thread count: $value.',
    );
  ...
  Widget build(BuildContext context) {
    ...
    assert(
      GeneralSettings.supportedEngineThreadCounts.contains(selected),
        ...
        child: RadioGroup<int>(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              for (final int value
                  in GeneralSettings.supportedEngineThreadCounts)
                RadioListTile<int>(
