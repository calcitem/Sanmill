...
final List<String> _bgList = <String>[
  Assets.images.icBackground1.path,
  Assets.images.icBackground2.path,
];

class _DesktopImageSelector extends StatelessWidget {
  const _DesktopImageSelector();

  @override
  Widget build(BuildContext context) {
    return Semantics(
      label: S.of(context).desktopImage,
          ...
          return GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return _BackgroundImageItem(
                asset: asset,
                isSelect: displaySettings.desktopImage == asset,
                onChanged: () {
                  DB().displaySettings =
                      displaySettings.copyWith(desktopImage: asset);
                },
              );
            },
