...
class GamePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isBackgroundDefault = DB().displaySettings.boardBackground.isEmpty;
        ...
        children: <Widget>[
          Container(
            decoration: BoxDecoration(
              color: isBackgroundDefault ? DB().colorSettings.darkBackgroundColor : null,
              image: isBackgroundDefault
                  ? null
                  : DecorationImage(
                image: AssetImage(DB().displaySettings.boardBackground),
                fit: BoxFit.cover,
              ),
            ),
          ),
