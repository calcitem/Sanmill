...
class GuidePainter extends CustomPainter {
  GuidePainter({this.blurIndex, this.focusIndex, required this.pieceList});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (focusIndex != null && MillController().gameInstance.gameMode != GameMode.setupPosition) {
    ...
    if (blurIndex != null && MillController().gameInstance.gameMode != GameMode.setupPosition) {
