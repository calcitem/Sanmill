...
void main() {
  ...
  setUp(() {
    ...
    // Configure mayRemoveMultiple=false for this test suite
    // Note: This needs to be set via DB().ruleSettings or MockDB
  });
  ...
  group('mayRemoveMultiple=false: Basic Behavior', () {
    ...
    test('FR-018: pieceToRemoveCount NOT pre-incremented with mayRemoveMultiple=false', () {
      ...
      expect(DB().ruleSettings.mayRemoveMultiple, isA<bool>(), reason: 'Configuration exists');
    });
    ...
    test('FR-019: Execute only chosen capture mode count', () {
      ...
      expect(position.pieceToRemoveCount[PieceColor.black],equals(1), reason: 'Custodian: 1 capture');
      ...
      expect(position.pieceToRemoveCount[PieceColor.black],equals(2), reason: 'Intervention: always 2 captures');
    });
  ...
  group('mayRemoveMultiple=false: Multi-Mill Scenarios', () {
    ...
    test('FR-037: Player can choose custodian instead of mill with mayRemoveMultiple=false', () {
      ...
      expect(position.pieceToRemoveCount[PieceColor.black],greaterThanOrEqualTo(1));
    });

    test('FR-037: Player can choose intervention instead of mill with mayRemoveMultiple=false', () {
    ...
    test('FR-038: Intervention requires 2 captures despite mayRemoveMultiple=false', () {
  ...
  group('mayRemoveMultiple=false: Combination Scenarios', () {
    ...
    test('Multi-mill + custodian available: choosing mill gives 1, choosing custodian gives 1', () {
    ...
    test('Multi-mill + intervention available: choosing intervention gives 2', () {
