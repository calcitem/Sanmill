...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(find.byKey(const Key('sanmill_home_daily_puzzle')), findsNothing);
      expect(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(find.byTooltip('Puzzle statistics'), findsOneWidget);
      ...
      final Finder lastMoveTile = find.byKey(
        const Key('display_settings_card_last_move_switch_tile'),
      );
      ...
      expect(lastMoveTile, findsOneWidget);
