...
struct _FlMethodCodecClass {
   ...
   * not able to encode.
   */
  GBytes *(*encode_method_call)(FlMethodCodec *codec, const gchar *name,
                                FlValue *args, GError **error);
   ...
   */
  gboolean (*decode_method_call)(FlMethodCodec *codec, GBytes *message,
                                 gchar **name, FlValue **args, GError **error);
   ...
   * not able to encode.
   */
  GBytes *(*encode_success_envelope)(FlMethodCodec *codec, FlValue *result,
                                     GError **error);
   ...
   * not able to encode.
   */
  GBytes *(*encode_error_envelope)(FlMethodCodec *codec, const gchar *code,
   ...
   */
  FlMethodResponse *(*decode_response)(FlMethodCodec *codec, GBytes *message,
                                       GError **error);
};
