...
const Rule RULES[N_RULES] = {
    {"Nine Men's Morris", "Nine Men's Morris", 9, 3, 3, false, MillFormationActionInPlacingPhase::removeOpponentsPieceFromBoard, false,
    ...
    {"Lasker Morris (WIP)", "Lasker Morris", 10, 3, 3, false, MillFormationActionInPlacingPhase::removeOpponentsPieceFromBoard, true,
     false, false, false, BoardFullAction::firstPlayerLose,
     StalemateAction::endWithStalemateLoss, true, 100, 100, true},
    {"Cheng San Qi", "Cheng San Qi", 9, 3, 3, false, MillFormationActionInPlacingPhase::removeOpponentsPieceFromBoard, false, false, false,
     false, BoardFullAction::firstPlayerLose,
     StalemateAction::endWithStalemateLoss, false, 100, 100, true},
    {"Da San Qi", "Da San Qi", 12, 3, 3, true, MillFormationActionInPlacingPhase::markAndDelayRemovingPieces, false, true, false, true,
     BoardFullAction::firstPlayerLose,
     StalemateAction::endWithStalemateLoss, false, 100, 100, true},
    {"Zhi Qi", "Zhi Qi", 12, 3, 3, true, MillFormationActionInPlacingPhase::removeOpponentsPieceFromBoard, false, false /* bmf */, false,
     false, BoardFullAction::firstAndSecondPlayerRemovePiece,
     StalemateAction::removeOpponentsPieceAndMakeNextMove, true, 100, 100,
     true},
    {"Experimental", "Experimental", 12, 3, 3, true, MillFormationActionInPlacingPhase::removeOpponentsPieceFromBoard, false, true, false,
     true, BoardFullAction::secondAndFirstPlayerRemovePiece,
     StalemateAction::endWithStalemateLoss, false, 100, 100, true},
};
