...
impl TgfSnapshot {
    pub(super) fn from_snap(snap: GameStateSnapshot) -> Self {
        Self {
...
pub fn tgf_kernel_create(game_id: String) -> Result<u32, String> {
    ...
    if game_id == "mill" {
        crate::games::mill::variant_extras::attach(id, tgf_mill::MillVariantOptions::default());
    }
    Ok(id)
}
...
mod tests {
    use super::*;
    use crate::api::mill_kernel::{tgf_kernel_create_mill, tgf_kernel_setup_set_piece};
    use crate::api::simple::{
        CaptureRuleConfig, MillBoardFullAction, MillFormationActionInPlacingPhase,
        MillVariantOptions, StalemateAction,
    };
