 ...
 */
export function cloud_mill_apply(request_json: string): string;
 ...
 */
export function cloud_mill_create(options_json: string): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly cloud_mill_apply: (a: number, b: number, c: number) => void;
    readonly cloud_mill_create: (a: number, b: number, c: number) => void;
