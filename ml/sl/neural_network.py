...
class SLNet(nn.Module):
    ...
    def __init__(self,
        ...
        logger.info(f"SLNet initialized: {input_channels} channels, "
...
class SLNetworkWrapper:
    ...
    def __init__(self,
        ...
        # Initialize network
        self.net = SLNet(**model_args).to(self.device)
        ...
        logger.info(f"SLNetworkWrapper initialized on device: {self.device}")
