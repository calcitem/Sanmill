...
class SelfPlayWorker:
    ...
    def __init__(self,
        ...
        self.neural_network = SLNetworkWrapper(model_args, device='cpu')  # Use CPU for workers
...
class SLTrainer:
    ...
    def __init__(self, args: Dict[str, Any]):
        ...
        self.neural_network = SLNetworkWrapper(model_args, device=self.device)
        ...
        logger.info(f"SLTrainer initialized on device: {self.device}")
